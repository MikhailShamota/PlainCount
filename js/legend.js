var legend = function() {
    ...
    function legend(g) {
        ...
        g.selectAll("g.legendCells")
            ...
            .on('mouseover', mouseOverCallback && function (d,i) {

                mouseOverCallback(i);
            })
            .on('mouseout', mouseOutCallback && function (d,i) {
    ...
    legend.callbackMouseOver = function( callback ) {

        if (!arguments.length) return mouseOverCallback;
        mouseOverCallback = callback;
        return this;
    }

    legend.callbackMouseOut = function( callback ) {

        if (!arguments.length) return mouseOutCallback;
